...
class AdminCompletedDonations extends StatefulWidget {
  static const String id = 'AdminCompletedDonations';
  const AdminCompletedDonations({super.key});

  @override
  State<AdminCompletedDonations> createState() =>
      _AdminCompletedDonationsState();
}

class _AdminCompletedDonationsState extends State<AdminCompletedDonations> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Completed Donation's")),
      body: FutureBuilder(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Completed on: ${donation['completionDate'] ?? 'N/A'}',
                                  style: const TextStyle(
                                      fontSize: 12,
