...
import 'package:food_cycle/screens/donater_screen/donator_active_donation/completed_donations/view_details_completed_donation.dart';

class CompleteDonation extends StatelessWidget {
  final String currentUserId = FirebaseAuth.instance.currentUser!.uid;

  CompleteDonation({super.key});
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(
                child: Text("No completed donations found.",
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String activeUserUid =
                  donation['activeuseruid'] ?? 'Unknown User';
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ViewDetailsCompletedDonation(
